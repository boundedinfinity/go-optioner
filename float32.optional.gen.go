...
//MarshalJSON marshals the Float32Optional type into the JSON representation.
...
//UnmarshalJSON unmarshals the JSON representation to the Float32Optional type.
...
//MarshalYAML marshals the Float32Optional type into the YAML representation.
func (t Float32Optional) MarshalYAML() (interface{}, error) {
	if t.IsDefined() {
		return *t.v, nil
	}
...
//UnmarshalYAML unmarshals the YAML representation to the Float32Optional type.
func (t *Float32Optional) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var v float32

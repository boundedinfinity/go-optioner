...
//MarshalJSON marshals the Uint32Optional type into the JSON representation.
...
//UnmarshalJSON unmarshals the JSON representation to the Uint32Optional type.
...
//MarshalYAML marshals the Uint32Optional type into the YAML representation.
func (t Uint32Optional) MarshalYAML() (interface{}, error) {
	if t.IsDefined() {
		return *t.v, nil
	}
...
//UnmarshalYAML unmarshals the YAML representation to the Uint32Optional type.
func (t *Uint32Optional) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var v uint32
...
func (t *Uint32Optional) String() string {
